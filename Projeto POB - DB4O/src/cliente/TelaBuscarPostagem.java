...
public class TelaBuscarPostagem extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaBuscarPostagem frame = new TelaBuscarPostagem();
		...
		btnCriar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					...
					textArea.setText(Fachada.buscarPostagens(termo));
				}
