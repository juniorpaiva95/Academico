...
//			Fachada.cadastrarFuncionario("Julia", new Date(format.parse("19/07/1985").getTime()), "Limpeza");
...
//			Fachada.cadastrarFilme(80, "Fausto", 0, "Filme de criança", "Procurando Nemo",new Date(format.parse("25/06/2010").getTime()));
